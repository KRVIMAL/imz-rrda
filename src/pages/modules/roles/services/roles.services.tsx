...
const transformRoleToRow = (role: RoleData): Row => {
  ...
  return {
    ...
    createdTime: new Date(role.createdAt).toISOString().split("T")[0],
    updatedTime: new Date(role.updatedAt).toISOString().split("T")[0],
    inactiveTime: new Date(role.updatedAt).toISOString().split("T")[0],
  };
};
